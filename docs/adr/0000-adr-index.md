# Índice de Registros de Decisiones de Arquitectura (ADR)

Este directorio contiene los Registros de Decisiones de Arquitectura (ADRs) para la prueba técnica **Agent Deployment Challenge**.

| ID ADR | Título | Estado | Fecha |
|--------|--------|--------|-------|
| [ADR-0001](file:///C:/proyectos/agent-deployment-challenge/docs/adr/0001-layered-architecture.md) | Adopción de Arquitectura por Capas y Validación de Esquemas | Aceptado | 2026-07-24 |
| [ADR-0002](file:///C:/proyectos/agent-deployment-challenge/docs/adr/0002-jwt-httponly-cookie-auth.md) | Autenticación JWT en Cookies HttpOnly | Aceptado | 2026-07-24 |
| [ADR-0003](file:///C:/proyectos/agent-deployment-challenge/docs/adr/0003-pgvector-cross-conversation-memory.md) | PostgreSQL + pgvector para Memoria RAG Multiconversación | Aceptado | 2026-07-24 |
